...
class GameObjectives(models.Model):
    match_player_detail_id_1 = models.ForeignKey('MatchesPlayersDetails', models.DO_NOTHING, db_column='match_player_detail_id_1', blank=True, null=True, related_name='mpd1')
    match_player_detail_id_2 = models.ForeignKey('MatchesPlayersDetails', models.DO_NOTHING, db_column='match_player_detail_id_2', blank=True, null=True, related_name='mpd2')
...
class MatchesPlayersDetails(models.Model):
    ...
    item_id_1 = models.ForeignKey(Items, models.DO_NOTHING, db_column='item_id_1', blank=True, null=True, related_name='item1')
    item_id_2 = models.ForeignKey(Items, models.DO_NOTHING, db_column='item_id_2', blank=True, null=True, related_name='item2')
    item_id_3 = models.ForeignKey(Items, models.DO_NOTHING, db_column='item_id_3', blank=True, null=True, related_name='item3')
    item_id_4 = models.ForeignKey(Items, models.DO_NOTHING, db_column='item_id_4', blank=True, null=True, related_name='item4')
    item_id_5 = models.ForeignKey(Items, models.DO_NOTHING, db_column='item_id_5', blank=True, null=True, related_name='item5')
    item_id_6 = models.ForeignKey(Items, models.DO_NOTHING, db_column='item_id_6', blank=True, null=True, related_name='item6')
    level = models.IntegerField(blank=True, null=True)
